...
func (s *SmartContract) EndParking(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	//TIME CALCULATIONS
  calculatedEndTime := CurrentTimestamp{TimeWindow: time.Minute * 5}
	...
	if math.Abs(time.Now().Sub(endorsedEndTime).Minutes()) < calculatedEndTime.TimeWindow {
