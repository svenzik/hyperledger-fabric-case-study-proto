...
type ParkingTime struct {
	...
	CostPerMinute big.Float `json:"costPerMinute"`
}
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	tuna := []Tuna{
		Tuna{Vessel: "SVEN", Location: "67.0006, -70.5476", Timestamp: "1504054225", Holder: "Miriam"},
		...
		Tuna{Vessel: "SVEN", Location: "51.9435, 8.2735", Timestamp: "1487745091", Holder: "Fatima", ParkingSpot: Parkingspot{Name: "Tartu-Sobra-tee-1-315", 
				[]ParkingTime{
...
func (s *SmartContract) recordTuna(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var tuna = Tuna{ Vessel: args[1], Location: args[2], Timestamp: args[3], Holder: args[4], Parkingspot: args[5] }
