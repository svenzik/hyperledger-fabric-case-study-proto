...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	tuna := []Tuna{
		Tuna{Vessel: "SVEN", Location: "67.0006, -70.5476", Timestamp: "1504054225", Holder: "SVEN"},
		Tuna{Vessel: "923F", Location: "67.0006, -70.5476", Timestamp: "1504054225", Holder: "Miriam2"},
	...
	fmt.Println("#### FINISHED INIT ####", tuna[i])
	return shim.Success(nil)
}
